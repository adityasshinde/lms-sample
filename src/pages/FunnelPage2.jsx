...
function FunnelPage2() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "https://sheet.best/api/sheets/884a1ce9-8213-448a-938f-d2132bec23cd",
        formData
      );
      ...
      window.location.href =
        "https://drive.google.com/file/d/1IRYJN1wCcsOn0oYjXxTtdBIzGQCQESdW/view?usp=sharing";
    } catch (error) {
    ...
    <div className="flex flex-col items-center justify-center h-screen bg-[#2B527A]">
      <div className="max-w-md bg-white p-8 rounded-lg shadow-md">
        ...
        <h1 className="text-2xl font-bold text-center mb-4">
          Download The Most Important Maths Questions PDF For Boards Exams
        </h1>
