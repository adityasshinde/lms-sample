...
import courseReviewImg from "../../assets/img/course/course-reviews-3.png";
import courseReviewImgTwo from "../../assets/img/course/course-reviews-2.png";
import courseReviewImgThree from "../../assets/img/course/course-reviews-1.png";
import { Link } from "react-router-dom";

const CourseDetailsReview = () => {
  return (
    <div className="course-detalis-reviews pt-4">
      <div className="course-detalis-reviews-tittle">
        <h3>Reviews</h3>
      </div>
      <div className="course-review-item mb-12">
