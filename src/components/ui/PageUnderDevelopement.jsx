...
import thinkingAvatar from '../../asset/images/avatar-thinking-6-svgrepo-com.svg';
import studyTable from '../../asset/images/study-student-svgrepo-com.svg';

const PageUnderDevelopement = ({type}) => {
    const imgToShow = (type === 'study' ? studyTable : thinkingAvatar);
  return (
    <div className='flex justify-center flex-col text-center h-[70vh]'>
